...
def build_step3_prompt(
    *,
    ...
    return (
        ...
        "- Use horizontal writing mode for all translated replacement text. This is mandatory.\n"
        f"- Write all translated {target_language} text horizontally inside each balloon.\n"
        "- Never use vertical text or vertical text layout under any circumstances.\n"
