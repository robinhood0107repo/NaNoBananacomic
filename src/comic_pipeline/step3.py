...
def build_step3_prompt(
    *,
    ...
    return (
        ...
        "- Use horizontal writing mode for the translated replacement text. This is mandatory.\n"
        f"- If the target language is {target_language}, write the translated {target_language} text horizontally.\n"
        f"- If the target language is {target_language}, do not use vertical {target_language} text or vertical text layout under any circumstances.\n"
